<?php
    ...
    define('UL_THEME', 'Plff');
    define('UL_VERSION', '1.0.1');
    ...
    // Исключить посты проектов домом, которые группой, список url
    $GLOBALS['exludeHomesPostSlugArr'] = array(
        'karkasnye-doma',
        'doma-iz-brusa',
        'doma-iz-kleenogo-brusa',
        'doma-iz-profilirovannogo-brusa',
        'doma-iz-gazobetona',
        'doma-iz-kirpicha',
        'hai-tek',
        'barnhouse',
