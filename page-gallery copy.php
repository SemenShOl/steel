      ...
      <div class="content">           
          ...
          <div class="portfolio-list">
            <div class="list">
                <?php
                $curImage = 0;
                foreach ($queryPortfolio->posts as $post):
                  setup_postdata($post); ?>
                        <a class="portfolio-list-item <?php if ($curImage >= 6)
                          echo 'is-hidden' ?>" data-fslightbox="gallery" href="<?php echo esc_url(fw_get_db_post_option($post->ID, 'plotnikoff_testimonials_video_preview')['url']); ?>">
                          <div class="portfolio-list-img-container">
                            <img class="portfolio-list-item-inner <?php if ($curImage < 6)
                              echo 'wow fadeIn --animation-image' ?> " src="<?php echo esc_url(fw_get_db_post_option($post->ID, 'plotnikoff_testimonials_video_preview')['url']); ?>"></img>
                          </div>
                        </a>
