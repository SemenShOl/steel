...
<?php 
    ...
    if ( $args['section-top-button'] ) ('<div class="buttons wow fadeIn" data-wow-delay=".5s">' . $args['section-top-button'] . '</div>');
    if ( $args['section-title'] ) $sectionTitle = $args['section-title'];
    if ( $args['section-open-item-modal'] ) $sectionOpenItemModal = $args['section-open-item-modal'];
