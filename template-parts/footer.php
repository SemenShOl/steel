			...
			<div class="row pc-border">
				...
				<div class="col-10">
					...
					<div class="block-main-menu menu-mobile">
						<div class="line-link">
							<ul class="inner">
								<li><a href="<?php echo home_url( '/o-kompanii/' ); ?>" class="link" style="grid-area: link-1;">О&nbsp;компании</a></li>
								<li><a href="<?php echo home_url( '/catalog' ); ?>" class="link" style="grid-area: link-2;">Каталог продукции</a></li>
								<li><a href="<?php echo home_url( '/services' ); ?>" class="link link-3" style="grid-area: link-3;">Услуги</a></li>
								<li><a href="<?php echo home_url( '/kontakty' ); ?>" class="link link-4" style="grid-area: link-4;">Контакты</a></li>
								<li><a href="<?php echo home_url( '/production' ); ?>" class="link link-5" style="grid-area: link-5;">Производство</a></li>
								<li><a href="<?php echo home_url( '/oplata-i-dostavka' ); ?>" class="link link-6" style="grid-area: link-6;">Оплата и&nbsp;доставка</a></li>
								<li><a href="<?php echo home_url( '/gallery' ); ?>" class="link link-7" style="grid-area: link-7;">Галерея</a></li>
							</ul>
						</div>
				</div>
				<div class="block-main-right">
					...
					<div class="block-main-right-top">
						...
						<button class="btn-icon white callback" data-bs-toggle="modal" data-bs-target="#modalCallback">
		...
		<div class="row">
			<div class="col-2">
				<div class="block-bottom-copyright">
					<p>© 2017 - <?php echo date('Y'); ?> ГК «МТК»<br> металлопродукция</p>
				</div>
			</div>
			<div class="col-10">
				<div class="block-bottom-content">
					<p class="block-bottom-content-text">
						...
						не&nbsp;является публичной офертой. Пользуясь сайтом и&nbsp;заполняя формы 
						обратной связи, Вы даете согласие на сбор, обработку и&nbsp;использование 
						Ваших персональных данных согласно 
						<a href="<?php echo home_url('/privacy') ?>" target="_blank">Политике конфиденциальности</a>
					</p>
					<div class="block-bottom-content-dev">
						<div class="item">
							<a href="https://solt.design/" target="_blank">
								<img class="footer-solt lazy" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/solt-logo.svg" alt="">
								<span>Сайт разработан<br> в <em>SOLT</em></span>
							</a>
						</div>
						<div class="item">
							<a href="https://demis.ru/" target="_blank">
								<img class="footer-solt lazy" data-src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/demis.webp" alt="">
