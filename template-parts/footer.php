		...
		<div class="ncol-10">
			...
			<div class="top-part">
				...
				<div class="top-part__contacts">
					...
					<!-- <a class="contacts__email" :href="'mailto:' + chosenPlace.email">steel-n2<span>@</span>bk.ru</a> -->
					<a class="contacts__email" :href="'mailto:' + chosenPlace.email">{{chosenPlace.email}}</a>
