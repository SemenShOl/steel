    ...
    public static function init()
    {
        ...
        if (!is_admin()) {
            ...
            function boxagency_additionally_scripts() {
                wp_add_inline_script( 'jquery', 'var globalParams = {site_url: "' . site_url() . '", ajax_url: "' . admin_url('admin-ajax.php') . '", theme_url: "' . get_template_directory_uri() . '", ya_metrika_id: "' . fw_get_db_settings_option('ul_general_yandex_metrika_id') . '"};' );
            }
