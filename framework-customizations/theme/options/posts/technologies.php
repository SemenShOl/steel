<?php
    ...
    $options = array(
        'plotnikoff_technologies_box' => array(
            'type' => 'box',
            ...
            'options' => array(
                ...
                'plotnikoff_technologies_introvideo_group' => array(
                    'type'  => 'group',
                    'options'  => array(
                        'plotnikoff_technologies_introvideo_preview' => array(
                            'type'  => 'upload',
                            'value' => '',
                            'label' => __('Интро видео, превью', 'ul'),
                        ),
                        'plotnikoff_technologies_introvideo_link' => array(
                            'type'  => 'text',
                            'value' => '',
                            'label' => __('Интро видео, ссылка на youtube, id видео', 'ul'),
                            'desc' => __('Например: l-o5jHhvyk8', 'ul'),
                        ),
                        // 'plotnikoff_technologies_introvideo_duration' => array(
                        //     'type'  => 'text',
                        //     'value' => '0:00',
                ...
                'plotnikoff_technologies_description_group' => array(
                    'type'  => 'group',
                    'options'  => array(
                        'plotnikoff_technologies_description' => array(
                            'type' => 'wp-editor',
                        ...
                        'plotnikoff_technologies_params' => array(
                            'type'  => 'addable-box',
                ...
                'plotnikoff_technologies_media_list' => array(
                    'type'  => 'addable-box',
                    'label' => __('Медиа', 'ul'),
                ...
                'plotnikoff_technologies_catalog_type' => array(
                    'type'  => 'select',
                    'value' => 'none',
